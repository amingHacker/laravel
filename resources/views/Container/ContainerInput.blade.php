...
<script type="text/javascript">
    ...
    $(document).ready(function () {      
        ...
        //站別
        $("#jqxcombobox_Station").jqxComboBox({ source: _StationType, selectedIndex: -1, width: '100px', height: '20' });

        var _StationType = ["清洗", "PP測試", "熱氮氣"];
        //站別
        $("#jqxcombobox_Bottle").jqxComboBox({ source: _StationType, selectedIndex: -1, width: '100px', height: '20' });
    });
    ...
    <div align="center">
        <table border="0" cellspacing="0" cellpadding="0" style="table-layout: fixed;">
            <tr>
                ...
                <td>
                    <input type="BUTTON" id="Sure" style="display:" value="確定" />
                </td>
            </tr>
            <tr>
                <td>
...
<div align = "center">
    ...
    <input type="BUTTON" class="btn btn-outline-info btn-space" id="ExportChart" style="display: none" value="圖表" />
    <input type="BUTTON" class="btn btn-outline-info btn-space" id="CloseChart" style="display: none" value="收合" />
    <input type="BUTTON" class="btn btn-outline-info btn-space" id="AutoUpdate" style="display: none" value="更新" />
</div>
<h1 class="my-4"></h1>
