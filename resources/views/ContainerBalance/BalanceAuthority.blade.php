...
    }
    ...
    function ShowTable(_todoP, i){
        ...
        $("#" + table).jqGrid({
            ...
            url:"BalanceAuthority/show/"+_todoP,
            datatype: "json",        
            altrows:false,
            width: jqgridWidth,
            height:'100%',
    ...
    function getAuthorityGroup(){     
        $.ajax({
            async:false,
            url: "BalanceAuthority/GetAuthorityGroup",//路徑
            type: "Get",
        }).done(function(data){
    ...
    $("#New").click( function(){
     ...
     $("#Save").click( function(){
        ...
        {     
            saveparameters = {
                        "successfunc" : null,
                        "url" : 'BalanceAuthority/AddandUpdate/'+0,
                        "extraparam" : {
                            "oper": oper,
                            "table": table,
                        },
            ...
            $("#confirmDialog").dialog({
                ...
                buttons : {
                    "確認" : function() {
                                ...
                                saveparameters = {
                                "successfunc" : null,
                                "url" : 'BalanceAuthority/AddandUpdate/'+ret.id,
                                "extraparam" : {                                   
                                    "id" : ret.id,
                                    "oper" : oper,
                                    "table": table,                                 
      ...
      $("#Delete").click( function() {
        var table = "dg" + $("#tabs .ui-tabs-active").text(); //呈現此table的title 
         ...
         if (s)	{
             ...
             {
                $.ajax({
                    url: "BalanceAuthority/delete/" + ret.id ,//路徑
                    type: "DELETE",           
                    data:{
                        "id": ret.id,
                        "table": table,
...
<script type="text/javascript">
    $("#ExportExcel").click(function(){        
        ...
        $.ajax({
                async:false,
                url: "BalanceAuthority/export" ,//路徑
                type: "POST",           
                data:{
                    "postData": postData,
                    "table":table,
                            ...
                            {                              
                                setTimeout((function (i) {                      
                                    return function () {                                                                       
                                        ...
                                        $.ajax({
                                            url: 'BalanceAuthority/FileUpload/' + data[i].id,
                                            method: 'post',
                                            async: false,//同步請求資料
                                            //datatype:"json",
                                            data: {
