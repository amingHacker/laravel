...
class ContainerBalanceController extends Controller
{
    //This is the controller index
    public function index( Request $request )
    {      
        $todosContainer_Balance = DB::connection('mysqlbalance')->table('container_balance_records')->orderBy('id','desc')->first();
        $todosContainer_Baseweight= DB::connection('mysqlbalance')->table('container_baseweight')->orderBy('id','desc')->first();
        $todosMaterial_Order= DB::connection('mysqlbalance')->table('material_order_weight')->orderBy('id','desc')->first();
        $todosPackaging_Weight= DB::connection('mysqlbalance')->table('packaging_material_weight')->orderBy('id','desc')->first();
        

        return view('ContainerBalance.ContainerBalance',[
            'todosContainer_Balance' => $todosContainer_Balance,
            'todosContainer_Baseweight' => $todosContainer_Baseweight,
            'todosMaterial_Order' => $todosMaterial_Order,
            'todosPackaging_Weight' => $todosPackaging_Weight,
        ]);
    }
    ...
    {    
        ...
        {
            case "/ContainerBalance/show/Container_Balance":
                $table = 'container_balance_records';
                break;
            case "/ContainerBalance/show/Container_Baseweight":
                $table = 'container_baseweight';
                break;
            case "/ContainerBalance/show/Material_Order":
                $table = 'material_order_weight';
                break;
            case "/ContainerBalance/show/Packaging_Weight":
                $table = 'packaging_material_weight';
                break;
        }
        // var_dump($_SERVER["REDIRECT_URL"]);

        $query = DB::connection('mysqlbalance')->table($table);
    ...
    {        
        ...
        switch ($downloadReq["table"]){
            case 'dgContainer_Balance':
                $table = 'container_balance_records';
                break;
            case 'dgContainer_Baseweight':
                $table = 'container_baseweight';
                break;
            case 'dgMaterial_Order':
                $table = 'material_order_weight';
                break;
            case 'dgPackaging_Weight':
                $table = 'packaging_material_weight';
                break;
        }
        ...
        {     
            ...
            //dd($Record);
            $DownLoadValue = DB::connection('mysqlbalance')->table($table)->limit(10000)->orderBy($sidx,'asc')->get();
    ...
    public function FileUpload( Request $request )
    {
        ...
        $updateData = DB::connection('mysqlbalance')->table($table)->where("id", $uploadData["UploadData"]["id"]);
        $isExist = DB::connection('mysqlbalance')->table($table)->where("id", $uploadData["UploadData"]["id"])->first();
    ...
    {   
        ...
        $deleteData = DB::connection('mysqlbalance')->table($table)->delete($Parameter["id"]);
        $UpdateValue = DB::connection('mysqlbalance')->table($table)->orderBy('id','asc')->get(); //回傳原本的資料
        return response()->json([
            //'success' =>  $UpdateValue
            'success' => 'OK'
    ...
    {      
        ...
        else
        {
            ...
            unset($AddParameter["caption"]);
            $updateData = DB::connection('mysqlbalance')->table($table)->where('id', $request->id);
    ...
    {    
        ...
        switch ($_SERVER["REDIRECT_URL"])
        {
            case "/ContainerBalance/GetTable/Container_Balance":
                $table = 'container_balance_records';
                break;
            case "/ContainerBalance/GetTable/Container_Baseweight":
                $table = 'container_baseweight';
                break;
            case "/ContainerBalance/GetTable/Material_Order":
                $table = 'material_order_weight';
                break;
            case "/ContainerBalance/GetTable/Packaging_Weight":
                $table = 'packaging_material_weight';
                break;
        }
        
        $product_SPEC= DB::connection('mysqlbalance')->table($table)->get();
    ...
    {    
        ...
        $container_addpackaging_weight_operator = DB::connection('mysqlbalance')->table('container_balance_records')->select('container_addpackaging_weight_operator')->distinct()->get();
        ...
        return response()->json([
            ...
            'container_base_weight_operator' => $container_base_weight_operator,
            'container_doing_weight_operator' => $container_doing_weight_operator ,
            'container_packaging_weight_operator' => $container_packaging_weight_operator,
            'container_addpackaging_weight_operator' => $container_addpackaging_weight_operator,
        ]);     
    }
    ...
    {  
        ...
        switch ($_SERVER["REDIRECT_URL"])
        {
            case "/ContainerBalance/GetDataFromID/Container_Balance":
                $table = 'container_balance_records';
                break;
            case "/ContainerBalance/GetDataFromID/Container_Baseweight":
                $table = 'container_baseweight';
                break;
            case "/ContainerBalance/GetDataFromID/Material_Order":
                $table = 'material_order_weight';
                break;
            case "/ContainerBalance/GetDataFromID/Packaging_Weight":
                $table = 'packaging_material_weight';
                break;
        }
