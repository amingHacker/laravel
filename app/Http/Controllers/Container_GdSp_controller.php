...
//  }
    ...
    public function CreateRowData($RowData)
    {
        $todo = Container_GdSp::create(
            [      
                ...
                'OriginalPipe' => $RowData["OriginalPipe"],
                'OriginalA3' => $RowData["OriginalA3"],
                'OriginalBody' => $RowData["OriginalBody"],
                'ProductName' => $RowData["ProductName"],
                'LeftMonitor_PipeCorrection' => $RowData["LeftMonitor_PipeCorrection"],
                'RightMonitor_PipeCorrection' => $RowData["RightMonitor_PipeCorrection"],
                'PipeCorrection' => $RowData["PipeCorrection"],
                'LeftMonitor_A3' => $RowData["LeftMonitor_A3"],
                'RightMonitor_A3' => $RowData["RightMonitor_A3"],
                'A3' => $RowData["A3"],
                'LeftMonitor_Body' => $RowData["LeftMonitor_Body"],
    ...
    public function CheckColumn($RowData)
    {
        ...
        $dbCol = [
            ...
            'OriginalBody',
            'ProductName',
            'LeftMonitor_PipeCorrection',	
            'RightMonitor_PipeCorrection',	
            'PipeCorrection',
            'LeftMonitor_A3',
            'RightMonitor_A3',
            'A3',
